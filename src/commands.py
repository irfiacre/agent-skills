...
from src.middleware import check_if_skill_exist
from src.utils import check_available_coding_agents, build_skill_template, SkillNotFoundError
...
def create_skill(skill_name: str, skill_description: str, project_level: bool = True) -> list:
    ...
    available_agents = check_available_coding_agents()
    ...
    for agent in available_agents:
        ...
        content = build_skill_template(name=skill_name, description=skill_description)
